                        ...
                        <div class="col-md-12 column">
                            <table class="table table-bordered table-hover table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td><img width="150px" height="100px" src="${productInfo.productIcon}"></img></td>
                                    ...
                                    <td>
                                        ...
                                        <#else>
                                            <a href="/sell/seller/product/up_sale?productId=${productInfo.productId}">上架</a>
                                        </#if>
                                    </td>
                                </tr>
                                </#list>
                    ...
                    <#--分页-->
                        <div class="col-md-12 column">
                            ...
                            <#list 1..productInfoPage.getTotalPages() as page>
                                ...
                                <#else >
                                    <li><a href="/sell/seller/product/list?size=${size}&page=${page}">${page}</a></li>
                                </#if>
                            </#list>
