...
import com.sea.sell.form.ProductForm;
...
public class SellerProductController {
    ...
    @GetMapping("/up_sale")
    public ModelAndView upSale(@RequestParam("productId") String productId,Map<String,Object> map){
        try{
...
//    @CacheEvict(cacheNames = "product",key = "123")
    public ModelAndView save(@Valid ProductForm form, BindingResult result,Map<String, Object> map){
        if (result.hasErrors()){
